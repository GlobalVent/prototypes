...
*/
int I2cMSxxx::setTestPressure(unsigned pressure) {
	uint8_t buf[3];
	buf[0] = (pressure >> 16);
	buf[1] = (pressure >> 8);
	buf[2] = pressure;
...
* @return int 
*/
int I2cMSxxx::setTestTemperature(unsigned temperature) {
	uint8_t buf[3];
	buf[0] = (_pressure >> 16);
	buf[1] = (_pressure >> 8);
	buf[2] = _pressure;
...
* @return int 
*/
int I2cMSxxx::getTestTemperature() {
	uint8_t buf[3];
