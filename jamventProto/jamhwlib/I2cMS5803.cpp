...
*/
uint32_t I2cMS5803::convertTemperature(uint32_t rawValue) {
	uint32_t C1 = _prom[1];
	uint32_t C2 = _prom[2];
	uint32_t C3 = _prom[3];
	uint32_t C4 = _prom[4];
...
* @return uint32_t -- converted pressure value, in mbar/10
*/
uint32_t I2cMS5803::convertPressure(uint32_t rawValue) {
